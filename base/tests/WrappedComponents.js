...
import put from 'put-selector/put';
import 'collections-amd/shim-array';
...
var WithTableLayout = function(args) {
    ...
    this.layout = function() {
        ...
        this._positionCell(this.cells[0][0], {
            x: 0,
            y: 0
        });
        this._positionCell(this.cells[0][1], {
            x: c0MaxWidth,
            y: 0
        });
        this._positionCell(this.cells[1][0], {
            x: 0,
            y: r0MaxHeight
        });
        this._positionCell(this.cells[1][1], {
            x: c0MaxWidth,
            y: r0MaxHeight
        });
...
var WithVFlexLayout = function(args) {
    ...
    this.layout = function() {
        ...
        this.flexChildren.forEach(function(child) {
            child.size({
                h: flexHeight / this.flexChildren.length
            });
        }.bind(this));
